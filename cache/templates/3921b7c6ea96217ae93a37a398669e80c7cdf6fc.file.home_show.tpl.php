...
<?php if ($_valid && !is_callable('content_60621005f050c')) {function content_60621005f050c($_smarty_tpl) {?><!DOCTYPE html>
...
content_60621005dde41($_smarty_tpl);
...
content_60621005e2cff($_smarty_tpl);
...
<?php }} ?><?php /* Smarty version Smarty-3.1.5, created on 2021-03-29 19:36:05
         compiled from "/Users/mchetrit/Dropbox/Work/APRIA/APRIA_WP/wp-content/themes/apria/templates/element_footer.tpl" */ ?>
<?php if ($_valid && !is_callable('content_60621005dde41')) {function content_60621005dde41($_smarty_tpl) {?><footer<?php if ($_smarty_tpl->tpl_vars['color']->value){?> style="color: <?php echo $_smarty_tpl->tpl_vars['color']->value;?>
...
<?php if ($_valid && !is_callable('content_60621005e2cff')) {function content_60621005e2cff($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['sidebar_issue']->value||$_smarty_tpl->tpl_vars['sidebar_posts']->value||$_smarty_tpl->tpl_vars['newsPosts']->value){?>
...
content_60621005e709f($_smarty_tpl);
...
<?php if ($_valid && !is_callable('content_60621005e709f')) {function content_60621005e709f($_smarty_tpl) {?>				<div class="article-preview <?php echo $_smarty_tpl->tpl_vars['classNames']->value;?>
