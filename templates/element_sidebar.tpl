			...
			<div class="content-wrap">
				{if $sidebar_issue}
					<div class="issue-preview clickable-block"
						 data-href="{$sidebar_issue->url}?color=ffffff&amp;bgcolor=000000&amp;opacity=0.2&amp;image=background_02.svg">
						<div class="preview__background"{if $sidebar_issue->background_image} style="background-image: url({$sidebar_issue->background_image});background-color:{$sidebar_issue->background_color};color:{$sidebar_issue->text_color}"{/if}>
							<a href="{$sidebar_issue->url}"
							   class="preview__title balance-text">{$sidebar_issue->title}</a>
